...
var DataGrid = /** @class */ (function () {
    ...
    * */
    ...
    DataGrid.prototype.renderViewport = function () {
        var _a, _b, _c, _d;
        var vp = this.viewport;
        var viewportMeta = vp === null || vp === void 0 ? void 0 : vp.getStateMeta();
        this.enabledColumns = this.getEnabledColumnIDs();
        (_a = this.credits) === null || _a === void 0 ? void 0 : _a.destroy();
        vp === null || vp === void 0 ? void 0 : vp.destroy();
        ...
        if ((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.credits) === null || _c === void 0 ? void 0 : _c.enabled) {
            this.credits = new Credits(this);
        }
        (_d = this.viewport) === null || _d === void 0 ? void 0 : _d.reflow();
    };
    /**
