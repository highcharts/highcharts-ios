...
var Table = /** @class */ (function () {
    ...
    * */
    ...
    Table.prototype.reflow = function () {
        ...
        var borderWidth = tableEl ? ((getStyle(tableEl, 'border-top-width', true) || 0) +
            (getStyle(tableEl, 'border-bottom-width', true) || 0)) : 0;
        this.tbodyElement.style.height = this.tbodyElement.style.minHeight = "".concat((((_a = this.dataGrid.container) === null || _a === void 0 ? void 0 : _a.clientHeight) || 0) -
            (((_b = this.theadElement) === null || _b === void 0 ? void 0 : _b.offsetHeight) || 0) -
            (((_c = this.captionElement) === null || _c === void 0 ? void 0 : _c.offsetHeight) || 0) -
            (((_d = this.dataGrid.credits) === null || _d === void 0 ? void 0 : _d.getHeight()) || 0) -
            borderWidth, "px");
        ...
        // Reflow the head
        (_e = this.header) === null || _e === void 0 ? void 0 : _e.reflow();
    ...
    Table.prototype.destroy = function () {
        ...
        (_a = this.columnsResizer) === null || _a === void 0 ? void 0 : _a.removeEventListeners();
