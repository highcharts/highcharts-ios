...
var Time = /** @class */ (function () {
    ...
    Time.prototype.update = function (options) {
        ...
        var timezone = (_a = options.timezone) !== null && _a !== void 0 ? _a : 'UTC';
        this.dTLCache = {};
    ...
    Time.prototype.dateFormat = function (format, timestamp, upperCaseFirst) {
        var _a;
        var lang = (_a = H.defaultOptions) === null || _a === void 0 ? void 0 : _a.lang;
        ...
        if (isString(format) && format.indexOf('%') !== -1) {
            ...
            var tzHours = (this.getTimezoneOffset(timestamp) || 0) /
                (60000 * 60), timeZone = this.options.timezone || ('Etc/GMT' + (tzHours >= 0 ? '+' : '') + tzHours), _c = format.prefix, prefix = _c === void 0 ? '' : _c, _d = format.suffix, suffix = _d === void 0 ? '' : _d;
