...
var extend = U.extend, getNestedProperty = U.getNestedProperty, isArray = U.isArray, isNumber = U.isNumber, isObject = U.isObject, pick = U.pick, ucfirst = U.ucfirst;
var helpers = {
    // Built-in helpers
...
function numberFormat(number, decimals, decimalPoint, thousandsSep) {
    ...
    number = +number || 0;
    decimals = +decimals;
    var ret, fractionDigits, _d = number.toString().split('e').map(Number), mantissa = _d[0], exp = _d[1];
    ...
    var hasSeparators = thousandsSep || decimalPoint, locale = hasSeparators ?
        'en' :
        ((this === null || this === void 0 ? void 0 : this.locale) ||
            lang.locale ||
            ((_b = doc.body.closest('[lang]')) === null || _b === void 0 ? void 0 : _b.lang)), cacheKey = JSON.stringify(options) + locale, nf = (_c = numberFormatCache[cacheKey]) !== null && _c !== void 0 ? _c : (numberFormatCache[cacheKey] = new Intl.NumberFormat(locale, options));
    ...
    if (hasSeparators) {
        ret = ret
            .replace(/\,/g, thousandsSep !== null && thousandsSep !== void 0 ? thousandsSep : ',')
            .replace('.', decimalPoint !== null && decimalPoint !== void 0 ? decimalPoint : '.');
    }
    if (
