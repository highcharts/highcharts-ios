...
var ColumnsResizer = /** @class */ (function () {
    ...
    function ColumnsResizer(viewport) {
        ...
        this.onDocumentMouseMove = function (e) {
            ...
            if (_this.viewport.columnDistribution === 'full') {
            ...
            _this.viewport.rowsVirtualizer.adjustRowHeights();
            (_d = (_c = (_b = (_a = _this.viewport.dataGrid.options) === null || _a === void 0 ? void 0 : _a.events) === null || _b === void 0 ? void 0 : _b.column) === null || _c === void 0 ? void 0 : _c.afterResize) === null || _d === void 0 ? void 0 : _d.call(_this.draggedColumn);
        };
        /**
    ...
    ColumnsResizer.prototype.addHandleListeners = function (handle, column) {
        ...
        var onHandleMouseDown = function (e) {
            ...
            _this.nextColumnStartWidth =
                (_a = _this.viewport.columns[column.index + 1]) === null || _a === void 0 ? void 0 : _a.getWidth();
            (_b = column.header) === null || _b === void 0 ? void 0 : _b.htmlElement.classList.add(Globals.classNames.resizedColumn);
        };
