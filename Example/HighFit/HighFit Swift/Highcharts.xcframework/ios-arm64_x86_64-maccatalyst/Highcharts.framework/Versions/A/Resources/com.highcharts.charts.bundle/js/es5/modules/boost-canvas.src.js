...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/Boost/BoostSeries.js', [_modules['Extensions/Boost/BoostableMap.js'], _modules['Extensions/Boost/Boostables.js'], _modules['Extensions/Boost/BoostChart.js'], _modules['Core/Defaults.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['Extensions/Boost/WGLRenderer.js']], function (BoostableMap, Boostables, BoostChart, D, H, U, WGLRenderer) {
        ...
        function scatterProcessData(force) {
            ...
            var boostThreshold = options.boostThreshold || 0, cropThreshold = options.cropThreshold, data = options.data || series.data, xData = series.xData, xExtremes = xAxis.getExtremes(), xMax = xExtremes.max, xMin = xExtremes.min, yData = series.yData, yExtremes = yAxis.getExtremes(), yMax = yExtremes.max, yMin = yExtremes.min;
            // Skip processing in non-boost zoom
            if (!series.boosted &&
                xAxis.old &&
                yAxis.old &&
                xMin >= ((_a = xAxis.old.min) !== null && _a !== void 0 ? _a : -Number.MAX_VALUE) &&
                xMax <= ((_b = xAxis.old.max) !== null && _b !== void 0 ? _b : Number.MAX_VALUE) &&
                yMin >= ((_c = yAxis.old.min) !== null && _c !== void 0 ? _c : -Number.MAX_VALUE) &&
                yMax <= ((_d = yAxis.old.max) !== null && _d !== void 0 ? _d : Number.MAX_VALUE)) {
                (_e = series.processedXData) !== null && _e !== void 0 ? _e : (series.processedXData = xData);
                (_f = series.processedYData) !== null && _f !== void 0 ? _f : (series.processedYData = yData);
                return true;
            }
            ...
            var processedData = [], processedXData = [], processedYData = [];
            var cropped = false, x, y;
    ...
    _registerModule(_modules, 'Extensions/BoostCanvas.js', [_modules['Extensions/Boost/BoostChart.js'], _modules['Extensions/Boost/BoostSeries.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (BoostChart, BoostSeries, Color, H, U) {
        ...
        var color = Color.parse;
        var composed = H.composed, doc = H.doc, noop = H.noop;
        ...
        (function (BoostCanvas) {
            ...
            function compose(ChartClass, SeriesClass, seriesTypes) {
                if (pushUnique(composed, compose)) {
                    var seriesProto = SeriesClass.prototype, AreaSeries_1 = seriesTypes.area, BubbleSeries_1 = seriesTypes.bubble, ColumnSeries_1 = seriesTypes.column, HeatmapSeries_1 = seriesTypes.heatmap, ScatterSeries_1 = seriesTypes.scatter;
