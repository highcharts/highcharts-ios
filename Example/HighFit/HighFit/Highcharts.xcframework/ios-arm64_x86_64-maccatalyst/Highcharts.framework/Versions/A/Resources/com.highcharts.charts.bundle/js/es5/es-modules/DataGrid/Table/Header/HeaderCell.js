...
var HeaderCell = /** @class */ (function (_super) {
    ...
    * */
    ...
    HeaderCell.prototype.render = function () {
        ...
        this.headerContent = makeHTMLElement(((_c = options.sorting) === null || _c === void 0 ? void 0 : _c.sortable) && column.data ? 'button' : 'span', {
    ...
    HeaderCell.prototype.reflow = function () {
        ...
        var width = 0;
        if (cell.columns) {
            for (var _i = 0, _b = cell.columns; _i < _b.length; _i++) {
                var col = _b[_i];
                width += ((_a = vp.getColumn(col.columnId || '')) === null || _a === void 0 ? void 0 : _a.getWidth()) || 0;
            }
        }
        else {
